...
describe("sources inventory", () => {
  ...
  it("groups entries deterministically with every category present", () => {
    ...
    // Docker + Homebrew + VS Code Marketplace), 6 ai-publishers (4 regional
    // press + Analytics Vidhya + latent.space; Synced Review retired 2026-09-24),
    ...
    expect(grouped.get("discussion")?.length).toBe(5);
